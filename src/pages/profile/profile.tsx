      ...
      <div className="relative">
        ...
        >
          {showPassword ? "Hide" : "See"}
            ...
            <label className="mt-10" htmlFor="">Instagram</label>
            <input className="mt-1 border border-gray-500 h-8 rounded-lg bg-gray-900" type="text" name="instagram" id="" />
            <label className="mt-10" htmlFor="">Twitter</label>
